 ...
 *
 * ReaderContext的扩展，具体与XmlBeanDefinitionReader使用。
 * 提供对在XmlBeanDefinitionReader配置的NamespaceHandlerResolver的访问。
 *
 * 继承自ReaderContext，你会发现只是提供了简单的NamespaceHandlerResolver
 *
 * @author Rob Harrop
